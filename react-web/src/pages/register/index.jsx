...
class Register extends Component {
	...
	bindClick() {
        const data = {
          ...
          if(!this.state.checked) return message.warning('请勾选《微藤用户协议》')
	...
	render() {
        const {enterpriseName, name, phone, phoneCaptcha, checked} = this.state;
        const _checked = !!enterpriseName && !!name&& !! phone&& !! phoneCaptcha&& !! checked
		return (
				...
				<div className="login-content">
					...
					<div className="login-main">
						...
						<div className="login-msg register-content">
							...
							<div className="box">
								<Button type="primary" onClick={this.bindClick} disabled={!_checked}>
									提交
								</Button>
							</div>
